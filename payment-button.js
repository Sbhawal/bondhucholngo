! function() {
    ...
    Array.prototype.fill || Object.defineProperty(Array.prototype, "fill", {
        value: function(t) {
            ...
            for (var e = Object(this), n = e.length >>> 0, r = arguments[1] >> 0, o = r < 0 ? Math.max(n + r, 0) : Math.min(r, n), r = arguments[2], r = void 0 === r ? n : r >> 0, i = r < 0 ? Math.max(n + r, 0) : Math.min(r, n); o < i;) e[o] = t, o++;
            return e
        }
        ...
        configurable: !0,
        writable: !0
    }), Array.from || (Array.from = (e = Object.prototype.toString, u = function(t) {
        ...
        return null
    }), "currentScript" in (l = document) || Object.defineProperty(l, "currentScript", {
        get: function() {
            try {
                throw new Error
            } catch (t) {
    ...
    var d, C = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    ...
    function R(t) {
        ...
        function v(t, e) {
            ...
            void 0 === r[g] && B(r);
            var o, i = n._state;
            return i ? (o = arguments[i - 1], s(function() {
        ...
        } : a ? (h = 0, a = new a(d), m = document.createTextNode(""), a.observe(m, {
            characterData: !0
        }), function() {
            m.data = h = ++h % 2
        }) : i ? ((p = new MessageChannel).port1.onmessage = d, function() {
        ...
        function _(t, e, n) {
            var o, i, r, a;
            e.constructor === t.constructor && n === v && e.constructor.resolve === b ? (r = t, 1 === (a = e)._state ? E(r, a._result) : 2 === a._state ? P(r, a._result) : O(a, void 0, function(t) {
                return x(r, t)
            }, function(t) {
                return P(r, t)
            })) : void 0 !== n && u(n) ? (o = e, i = n, s(function(n) {
                var r = !1,
                    t = function(t, e) {
                        try {
                            t.call(e, function(t) {
        ...
        var T = (j.prototype._enumerate = function(t) {
            ...
            if (r === b) {
                ...
                i === v && void 0 !== e._state ? this._settledAt(e._state, t, e._result) : "function" != typeof i ? (this._remaining--, this._result[t] = e) : n === R ? (o = new n(w), s ? P(o, a) : _(o, e, i), this._willSettleAt(o, t)) : this._willSettleAt(new n(function(t) {
                    return t(e)
                }), t)
        ...
        function j(t, e) {
            this._instanceConstructor = t, this.promise = new t(w), this.promise[g] || B(this.promise), n(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? E(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && E(this.promise, this._result))) : P(this.promise, new Error("Array Methods must be provided an Array"))
        }
        var R = (z.prototype.catch = function(t) {
        ...
        function z(t) {
            this[g] = $++, this._result = this._state = void 0, this._subscribers = [], w !== t && ("function" != typeof t && function() {
        ...
        return R.prototype.then = v, R.all = function(t) {
        ...
        }, R.resolve = b, R.reject = function(t) {
            var e = new this(w);
            return P(e, t), e
    ...
    }(), tt.exports.polyfill(), String.prototype.includes || (String.prototype.includes = function(t, e) {
    ...
    function K(t, e, n, r) {
        t && t.o && (H.has(t) || (H.add(t), Z.c.push(function() {
    ...
    function W(n, t, e) {
        var r = n.$$,
            ...
            a = r.on_destroy,
            r = r.after_update;
        o && o.m(t, e), F(function() {
            var t, e = i.map(h).filter(v);
    ...
    function Y(r, t, e, n, o, i, a) {
        ...
        var u = t.props || {},
            ...
            f = !1;
        c.ctx = e ? e(r, u, function(t, e) {
            var n = !(arguments.length <= 2) && arguments.length - 2 ? arguments.length <= 2 ? void 0 : arguments[2] : e;
            return c.ctx && o(c.ctx[t], c.ctx[t] = n) && (!c.skip_bound && c.bound[t] && c.bound[t](n), f && (n = t, -1 === (t = r).$$.dirty[0] && (z.push(t), U || (U = !0, D.then(Q)), t.$$.dirty.fill(0)), t.$$.dirty[n / 31 | 0] |= 1 << n % 31)), e
        }) : [], c.update(), f = !0, y(c.before_update), c.fragment = !!n && n(c.ctx), t.target && (t.hydrate ? (n = t.target, n = Array.from(n.childNodes), c.fragment && c.fragment.l(n), n.forEach(P)) : c.fragment && c.fragment.c(), t.intro && J(r.$$.fragment), W(r, t.target, t.anchor), Q()), R(s)
    }
    var tt = ((ht = nt.prototype).$destroy = function() {
    ...
    var rt = function(o, r) {
        ...
        return {
            ...
            subscribe: function(t, e) {
                void 0 === e && (e = g);
                var n = [t, e];
                return a.push(n), 1 === a.length && (i = r(s) || g), t(o),
                    function() {
                        var t = a.indexOf(n); - 1 !== t && a.splice(t, 1), 0 === a.length && (i(), i = null)
                    }
            }
        }
    }({
    ...
    var ut, ct = ((ht = {}).lj = "96df432a283745908a06f711acd9e5eb", ht),
        ft = ["ga", "hotjar", "perf"],
        lt = {
            ...
            init: function(t, e) {
                var n;
                void 0 === e && (e = "native"), window.rzpQ || (n = t, window.analytics ? window.analytics.createQ && (window.rzpQ = window.analytics.createQ({
                    pollFreq: 500
                })) : (t = function() {}, window.rzpQ = Object.assign({
                    interaction: t,
                    initiated: t,
                    dropped: t,
                    success: t,
        ...
        dt = {
            ...
            init: function(r, o) {
                at("https://cdn.razorpay.com/static/analytics/bundle.js", function() {
                    var e, n;
                    void 0 === (t = ["lj"]) && (t = ft), window.razorpayAnalytics || window.analytics ? (e = [], n = {}, t.forEach(function(t) {
                        e.push(t), ct[t] && (n[t] = ct[t])
                    }), (window.razorpayAnalytics || window.analytics).init(e, n, !1, void 0, !1, void 0)) : window.analytics = {
                        track: function() {}
                    };
                    var t = {
                    ...
                    window.rzpQ && window.rzpQ.defineEventModifiers({
                        paymentButton: [{
    ...
    function pt(t, e) {
        window.rzpQ && window.rzpQ.paymentButton && window.rzpQ.push(window.rzpQ.now().paymentButton().interaction("button.website." + t, Object.assign({}, e, {
            mode: "live",
            type: "payment",
            plugin_source: ut
        })))
    ...
    ht = window.addEventListener ? "addEventListener" : "attachEvent", (0, window[ht])("attachEvent" == ht ? "onmessage" : "message", function(t) {
        event.origin;
        var e, n = t[t.message ? "message" : "data"];
        switch (st(n.event_type, n.data), n.event_type) {
            ...
            case "iframe_contents_loaded":
                it({
                    isIframeContentsLoaded: !0
                })
        }
    }, !1);
    var bt, gt = (o(wt, bt = tt), t(wt, [{
        key: "show",
        get: function() {
            return this.$$.ctx[0]
        },
    ...
    function wt(t) {
        var e, n = bt.call(this) || this;
        return document.getElementById("svelte-q4m8xw-style") || ((e = O("style")).id = "svelte-q4m8xw-style", e.textContent = ".razorpay-loader.svelte-q4m8xw{position:relative;height:50px;width:50px;border-radius:50%;top:30%;margin:0 auto;border:1px solid rgba(255,255,255,0.2);border-top-color:rgba(255,255,255,0.7);animation:svelte-q4m8xw-rzp-rot 1s infinite linear;transition:.2s;opacity:0}@-moz-keyframes svelte-q4m8xw-rzp-rot{100%{transform:rotate(360deg)}}@-webkit-keyframes svelte-q4m8xw-rzp-rot{100%{transform:rotate(360deg)}}@-o-keyframes svelte-q4m8xw-rzp-rot{100%{transform:rotate(360deg)}}@keyframes svelte-q4m8xw-rzp-rot{100%{transform:rotate(360deg)}}", k(document.head, e)), Y(i(n), t, vt, yt, w, {
            show: 0
        }), n
    }

    function _t(n) {
        var r, o, i, a, s, u, c, f, l, d = new gt({
            props: {
                show: n[1]
            }
        });
        return {
            c: function() {
                r = O("div"), o = O("div"), i = O("span"), a = S("Test Mode"), s = $(), V(d.$$.fragment), u = $(), c = O("iframe"), B(i, "class", "test-mode-badge svelte-7tbrl8"), B(i, "style", n[5]), B(o, "class", "razorpay-backdrop svelte-7tbrl8"), B(o, "style", n[4]), B(c, "title", "payment-form"), B(c, "class", "razorpay-payment-form-frame svelte-7tbrl8"), B(c, "frameborder", "0"), B(c, "height", "100%"), B(c, "width", "100%"), B(c, "allowtransparency", "true"), c.allowPaymentRequest = "true", c.src !== (f = n[0]) && B(c, "src", f), B(r, "class", "razorpay-payment-form-container svelte-7tbrl8"), B(r, "style", n[2])
            },
            m: function(t, e) {
    ...
    function xt(t, e, n) {
        ...
        var o, i, a, s, u, c = r.paymentFormUrl;
        return r.isQATestMode && (u = r.paymentButtonOptions.payment_button_id, c = r.baseUrl + "/payment_buttons/" + u + "/view"), t.$$.update = function() {
            8 & t.$$.dirty && n(2, i = r.isPaymentFormOpened ? "" : "display: none;"), 8 & t.$$.dirty && n(4, a = r.isPaymentFormOpened ? "opacity:1;" : ""), 8 & t.$$.dirty && n(5, s = r.isTestMode ? "opacity:1;" : ""), 8 & t.$$.dirty && (r.isPaymentFormOpened ? (n(1, o = !0), r.isIframeContentsLoaded && setTimeout(function() {
                n(1, o = !1)
            }, 1e3)) : n(1, o = !1))
        }, [c, o, i, r, a, s, function(t) {
            L[t ? "unshift" : "push"](function() {
                r.modalFrameEl = t, rt.set(r)
            })
        }]
    }
    var kt, Et = (o(Ot, kt = tt), Ot),
        Pt = {
    ...
    function $t(o) {
        var i, a, s, u, c, f, l, n, d, p, r, h, m, y = o[3] && {
                c: function() {
                    r = A("svg"), h = A("path"), m = A("path"), B(h, "d", ""), B(h, "fill", "#fff"), B(h, "class", "svelte-ekc7fv"), B(m, "d", ""), B(m, "fill", "#fff"), B(m, "class", "svelte-ekc7fv"), B(r, "width", "18"), B(r, "height", "20"), B(r, "viewBox", "0 0 18 20"), B(r, "fill", "none"), B(r, "xmlns", "http://www.w3.org/2000/svg"), B(r, "class", "svelte-ekc7fv")
                },
                m: function(t, e) {
                    E(t, r, e), k(r, h), k(r, m)
                },
        ...
        return {
            c: function() {
                i = O("a"), y && y.c(), a = $(), s = O("div"), u = O("span"), c = S(o[0]), f = $(), l = O("div"), v.c(), B(u, "class", "PaymentButton-text svelte-ekc7fv"), B(l, "class", "PaymentButton-securedBy svelte-ekc7fv"), B(s, "class", "PaymentButton-contents svelte-ekc7fv"), B(i, "href", o[5]), B(i, "type", "submit"), B(i, "class", n = x(o[1]) + " svelte-ekc7fv"), j(i, "background", o[2] || "")
            },
            m: function(t, e) {
                var n, r;
                E(t, i, e), y && y.m(i, null), k(i, a), k(i, s), k(s, u), k(u, c), k(s, f), k(s, l), v.m(l, null), d || (n = i, r = o[9], n.addEventListener("click", r, void 0), p = function() {
    ...
    function Bt(n, t, e) {
        ...
        var o, i = t.brandColor,
            ...
            p = !0;
        return d ? Pt.RZP_DARK_STANDARD === a && (p = !1) : (o = Pt.BRAND_COLOR === a ? i : a, p = !(colorLib && colorLib.isDark(o))), t = "PaymentButton", t += " PaymentButton--" + (p ? "light" : "dark"), d && (t += " PaymentButton--rzpTheme", t += " PaymentButton--" + a), c || (t += " PaymentButton--noRzpLogo"), f && (t += " PaymentButton--customSecuredByLogo"), n.$$set = function(t) {
        ...
        }, [s, t, o, c, f, l, i, a, u, function(t) {
            var e;
            e = t, (t = n.$$.callbacks[e.type]) && t.slice().forEach(function(t) {
                return t(e)
            })
        }]
    }
    var Tt, jt = (o(Rt, Tt = tt), t(Rt, [{
        key: "brandColor",
        get: function() {
            return this.$$.ctx[6]
        },
    ...
    function Rt(t) {
        var e, n = Tt.call(this) || this;
        return document.getElementById("svelte-ekc7fv-style") || ((e = O("style")).id = "svelte-ekc7fv-style", e.textContent = "@import url(\"https://fonts.googleapis.com/css2?family=Muli:wght@700;800&display=swap\");.PaymentButton.svelte-ekc7fv.svelte-ekc7fv{position:relative;display:inline-block;min-width:160px;height:40px;padding:0;border-radius:3px;text-align:center;font-style:italic;font-family:Muli,helvetica,sans-serif;font-display:swap;overflow:hidden;border:1px solid transparent;outline:none;cursor:pointer;-webkit-tap-highlight-color:transparent;text-decoration:none}.PaymentButton--customSecuredByLogo.svelte-ekc7fv.svelte-ekc7fv{height:2px}.PaymentButton--dark.svelte-ekc7fv.svelte-ekc7fv{color:#fff}.PaymentButton--rzpTheme.svelte-ekc7fv.svelte-ekc7fv::before{content:'';position:absolute;left:-6px;top:0;width:46px;height:100%;background:#1e40a0;border-radius:2px 0 0 2px;transform:skew(-15deg,0)}.PaymentButton--rzp-outline-standard.svelte-ekc7fv.svelte-ekc7fv{background:#eaf2fe;border-color:#1e40a0}.PaymentButton--rzp-outline-standard.svelte-ekc7fv.svelte-ekc7fv::before{box-shadow:2px 0 4px rgba(0,0,0,0.15)}.PaymentButton--rzp-light-standard.svelte-ekc7fv.svelte-ekc7fv{background:#fff;border-color:#fff}.PaymentButton--rzp-light-standard.svelte-ekc7fv.svelte-ekc7fv::before{box-shadow:2px 0 4px rgba(0,0,0,0.15)}svg.svelte-ekc7fv.svelte-ekc7fv{position:absolute;top:0;left:0;margin:9px 11px}svg.svelte-ekc7fv svg path.svelte-ekc7fv{fill:#fff}.PaymentButton--rzpTheme.svelte-ekc7fv svg path.svelte-ekc7fv{fill:#fff}.PaymentButton--light.svelte-ekc7fv:not(.PaymentButton--rzpTheme) svg path.svelte-ekc7fv{fill:black}.PaymentButton.svelte-ekc7fv.svelte-ekc7fv:not(.PaymentButton--rzpTheme):not(.PaymentButton--noRzpLogo)::before{content:'';position:absolute;bottom:0;left:0;top:0;right:0;background:linear-gradient(121deg,rgba(255,255,255,0) 40%,rgba(255,255,255,0.2) 100%)}.PaymentButton-contents.svelte-ekc7fv.svelte-ekc7fv{padding:4px 28px 4px 44px;margin:1px 0}.PaymentButton--noRzpLogo.svelte-ekc7fv .PaymentButton-contents.svelte-ekc7fv{padding-left:28px !important}.PaymentButton--rzpTheme.svelte-ekc7fv .PaymentButton-contents.svelte-ekc7fv{padding-left:60px}.PaymentButton-text.svelte-ekc7fv.svelte-ekc7fv{display:block;min-height:18px;line-height:18px;font-size:14px;font-weight:800;opacity:1;text-transform:initial}.PaymentButton-securedBy.svelte-ekc7fv.svelte-ekc7fv{font-size:8px;line-height:10px;text-transform:initial;margin-top:0;opacity:.6}.PaymentButton--customSecuredByLogo.svelte-ekc7fv .PaymentButton-securedBy.svelte-ekc7fv{opacity:1;margin-top:1px}.secured-by-logo.svelte-ekc7fv.svelte-ekc7fv{vertical-align:middle}", k(document.head, e)), Y(i(n), t, Bt, $t, w, {
            brandColor: 6,
            buttonTheme: 7,
            buttonText: 0,
            brandingOptions: 8
    ...
    function Ct(t, e, n) {
        ...
        function c(t) {
            var n, r, e = i.paymentButtonOptions,
                o = (n = i.paymentButtonOptions, r = {}, Object.keys(n).forEach(function(t) {
                    var e = function(t, e) {
        ...
        return a = i.buttonPreferences.data.merchant_brand_color, o = u.button_text, r = u.button_theme, u = i.buttonPreferences.data.branding || {}, Object.keys(Pt).find(function(t) {
            return Pt[t] === r
        }) || (r = ""), r = r || i.buttonPreferences.data.payment_button_theme, o = o || i.buttonPreferences.data.payment_button_text, t.$$.update = function() {
            96 & t.$$.dirty && i.isPaymentFormOpened && i.isIframeContentsLoaded && function(t) {
                st();
                var e = ot(),
                    n = e.modalFrameEl;
                e.isQATestMode && (e = e.baseUrl, t.base_url = e.replace("/v1", "")), t.is_mobile = window.innerWidth && window.innerWidth < 450 || mt || window.matchMedia("(max-device-height: 450px),(max-device-width: 450px)").matches, t = {
                    event_type: "init_payment_form",
                    data: t
                }, dt.lj.modalOpenSuccess(), n.contentWindow.postMessage(t, "*")
            }(s)
        }, [r, o, a, u, function(t) {
            t.preventDefault(), st(), n(5, s = c({})), it({
                isPaymentFormOpened: !0
            }), dt.lj.buttonClicked()
        }]
    }
    var Lt, Nt, Mt = (o(Dt, Nt = tt), Dt);
    ...
    function Ft(e) {
        if (Lt && e) return Lt.run ? Lt.run(function(t) {
    ...
    function Zt(t) {
        var n, r, o = t[0].buttonPreferences.error + "";
        return {
            c: function() {
                n = O("span"), r = S(o)
            },
    ...
    function Jt(t) {
        ...
        return ~(o = u(t)) && (i = s[o] = a[o](t)), {
            ...
            p: function(t, e) {
                var e = b(e, 1)[0],
                    n = o;
                (o = u(t)) === n ? ~o && s[o].p(t, e) : (i && (Z = {
                    r: 0,
                    c: [],
                    p: Z
                }, K(s[n], 1, 1, function() {
                    s[n] = null
                }), Z.r || y(Z.c), Z = Z.p), ~o ? ((i = s[o]) || (i = s[o] = a[o](t)).c(), J(i, 1), i.m(r, null)) : i = null)
            },
            i: function(t) {
                n || (J(i), n = !0)
            },
    ...
    function Kt(t, e, n) {
        var r;
        return _(t, rt, function(t) {
                return n(0, r = t)
            }), t = function() {
                new Et({
                    target: document.body
                }), Ut({
                    dsn: "https://f961b7066bfe44088760160df4cfe41e@sentry9.razorpay.com/23",
                    defaultIntegrations: !1
                }, It), dt.init(r.paymentButtonOptions.payment_button_id, r.paymentButtonOptions.plugin)
            },
            function() {
    ...
    var Vt, Wt = (o(Yt, Vt = tt), Yt),
        Gt = Object.prototype.toString;

    function Yt(t) {
        var e, n = Vt.call(this) || this;
        return Qt.getElementById("svelte-ohbfj8-style") || ((e = O("style")).id = "svelte-ohbfj8-style", e.textContent = ".razorpay-payment-button.svelte-ohbfj8,.razorpay-payment-button.svelte-ohbfj8 *,.razorpay-payment-button.svelte-ohbfj8 *::before,.razorpay-payment-button.svelte-ohbfj8 *::after{box-sizing:border-box;padding-right: 15px;height:20px;}.razorpay-payment-button.svelte-ohbfj8{position:relative;display:inline-block;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}", k(Qt.head, e)), Y(i(n), t, Kt, Jt, w, {}), n
    }
    ...
    function ue(t, e, n) {
        return e && (n = n ? n(e) : ae.isURLSearchParams(e) ? e.toString() : (r = [], ae.forEach(e, function(t, e) {
            null != t && (ae.isArray(t) ? e += "[]" : t = [t], ae.forEach(t, function(t) {
                ae.isDate(t) ? t = t.toISOString() : ae.isObject(t) && (t = JSON.stringify(t)), r.push(se(e) + "=" + se(t))
            }))
        }), r.join("&"))) && (-1 !== (e = t.indexOf("#")) && (t = t.slice(0, e)), t += (-1 === t.indexOf("?") ? "?" : "&") + n), t;
        var r
    }
    ...
    function fe(e, n, t) {
        return ae.forEach(t, function(t) {
            e = t(e, n)
        }), e
    }
    ...
    function pe(t, e, n, r, o) {
        return t = new Error(t), n = n, r = r, o = o, t.config = e, n && (t.code = n), t.request = r, t.response = o, t.isAxiosError = !0, t.toJSON = function() {
            return {
    ...
    var he, me, ye, ve = ce,
        be = ae.isStandardBrowserEnv() ? {
            write: function(t, e, n, r, o, i) {
                var a = [];
                a.push(t + "=" + encodeURIComponent(e)), ae.isNumber(n) && a.push("expires=" + new Date(n).toGMTString()), ae.isString(r) && a.push("path=" + r), ae.isString(o) && a.push("domain=" + o), !0 === i && a.push("secure"), document.cookie = a.join("; ")
            },
            read: function(t) {
        ...
        ge = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"],
        we = ae.isStandardBrowserEnv() ? (me = /(msie|trident)/i.test(navigator.userAgent), ye = document.createElement("a"), he = xe(window.location.href), function(t) {
    ...
    function xe(t) {
        return me && (ye.setAttribute("href", t), t = ye.href), ye.setAttribute("href", t), {
            href: ye.href,
    ...
    var Ee = {
        adapter: (("undefined" != typeof XMLHttpRequest || "undefined" != typeof process && "[object process]" === Object.prototype.toString.call(process)) && (Le = function(f) {
            return new Promise(function(s, u) {
                ...
                var t, e, o, i = (e = f.baseURL, i = f.url, e && !/^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(i) ? (t = e, (e = i) ? t.replace(/\/+$/, "") + "/" + e.replace(/^\/+/, "") : t) : i);
                if (c.open(f.method.toUpperCase(), ue(i, f.params, f.paramsSerializer), !0), c.timeout = f.timeout, c.onreadystatechange = function() {
                        var e, n, r, t, o, i, a;
                        c && 4 === c.readyState && (0 !== c.status || c.responseURL && 0 === c.responseURL.indexOf("file:")) && (i = "getAllResponseHeaders" in c ? (o = c.getAllResponseHeaders(), r = {}, o && ae.forEach(o.split("\n"), function(t) {
                            n = t.indexOf(":"), e = ae.trim(t.substr(0, n)).toLowerCase(), n = ae.trim(t.substr(n + 1)), e && (r[e] && 0 <= ge.indexOf(e) || (r[e] = "set-cookie" === e ? (r[e] || []).concat([n]) : r[e] ? r[e] + ", " + n : n))
                        }), r) : null, a = {
                            data: f.responseType && "text" !== f.responseType ? c.response : c.responseText,
                            status: c.status,
                            statusText: c.statusText,
                            headers: i,
                            config: f,
                            request: c
                        }, t = s, o = u, a = (i = a).config.validateStatus, i.status && a && !a(i.status) ? o(pe("Request failed with status code " + i.status, i.config, null, i.request, i)) : t(i), c = null)
                    }, c.onabort = function() {
                    ...
                    }, ae.isStandardBrowserEnv() && (o = (f.withCredentials || we(i)) && f.xsrfCookieName ? be.read(f.xsrfCookieName) : void 0) && (r[f.xsrfHeaderName] = o), "setRequestHeader" in c && ae.forEach(r, function(t, e) {
                        void 0 === n && "content-type" === e.toLowerCase() ? delete r[e] : c.setRequestHeader(e, t)
                    }), ae.isUndefined(f.withCredentials) || (c.withCredentials = !!f.withCredentials), f.responseType) try {
                    c.responseType = f.responseType
                } catch (s) {
                    if ("json" !== f.responseType) throw s
                }
                "function" == typeof f.onDownloadProgress && c.addEventListener("progress", f.onDownloadProgress), "function" == typeof f.onUploadProgress && c.upload && c.upload.addEventListener("progress", f.onUploadProgress), f.cancelToken && f.cancelToken.promise.then(function(t) {
                    c && (c.abort(), u(t), c = null)
                }), n = n || null, c.send(n)
            })
        }), Le),
        transformRequest: [function(t, e) {
            return de(e, "Accept"), de(e, "Content-Type"), ae.isFormData(t) || ae.isArrayBuffer(t) || ae.isBuffer(t) || ae.isStream(t) || ae.isFile(t) || ae.isBlob(t) ? t : ae.isArrayBufferView(t) ? t.buffer : ae.isURLSearchParams(t) ? (ke(e, "application/x-www-form-urlencoded;charset=utf-8"), t.toString()) : ae.isObject(t) ? (ke(e, "application/json;charset=utf-8"), JSON.stringify(t)) : t
        }],
    ...
    function Ae(e) {
        return Oe(e), e.headers = e.headers || {}, e.data = fe(e.data, e.headers, e.transformRequest), e.headers = ae.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers), ae.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function(t) {
            delete e.headers[t]
        }), (e.adapter || Pe.adapter)(e).then(function(t) {
    ...
    function Se(e, n) {
        ...
        }), ae.forEach(o, u), ae.forEach(i, function(t) {
        ...
        var c = t.concat(o).concat(i).concat(a),
            a = Object.keys(e).concat(Object.keys(n)).filter(function(t) {
    ...
    $e.prototype.request = function(t) {
        "string" == typeof t ? (t = arguments[1] || {}).url = arguments[0] : t = t || {}, (t = Se(this.defaults, t)).method ? t.method = t.method.toLowerCase() : this.defaults.method ? t.method = this.defaults.method.toLowerCase() : t.method = "get";
        var e = [Ae, void 0],
            n = Promise.resolve(t);
    ...
    var Ce = ze(Pe);
    Ce.Axios = Be, Ce.create = function(t) {
        return ze(Se(Ce.defaults, t))
    }, Ce.Cancel = je, Ce.CancelToken = tt, Ce.isCancel = le, Ce.all = function(t) {
    ...
    function Me(t, e) {
        ...
        return "test" === window.RZP.environment && window.RZP.base_url && (r = window.RZP.base_url), Ne.defaults.baseURL = r || "https://api.razorpay.com/v1",
            function(t, e) {
                var n = ot(),
            ...
            }(), (r = ot().paymentButtonOptions.button_theme) && Pt.BRAND_COLOR !== r || (it({
                isColorJSLoading: !0
    ...
    window.RZP = window.RZP || {}, tt = document.currentScript, "FORM" !== (Le = tt.parentElement).tagName && window.alert("Payment Button is not added. Add Button script inside 'form' tag."), tt = tt.dataset, st(), Me(Le, tt)
}();